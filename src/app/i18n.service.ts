...
const translations = {
  fr: {
    ...
    'page.showcase': 'Système d’interface — froment.software',
    ...
    'page.description.showcase': 'Aperçu du système visuel et des composants employés par froment.software.',
    ...
    'products.contact.showcase': 'Explorer Froment UI',
    ...
    'showcase.kicker': 'Système d’interface',
    'showcase.title': 'Froment UI',
    'showcase.lead': 'Des composants francs, lisibles et fonctionnels. Le relief n’apparaît que lorsqu’il clarifie l’action.',
    ...
    'showcase.form.projectLabel': 'Projet client',
    'showcase.form.environmentLabel': 'Environnement',
    ...
    'showcase.table.caption': 'État des services de démonstration',
    'showcase.table.openFor': 'Ouvrir les détails de {service}',
    ...
    'showcase.table.close': 'fermer',
    'showcase.search.label': 'Rechercher un service',
    'showcase.search.placeholder': 'Nom du service',
    'showcase.filter.status': 'Filtrer par statut',
    'showcase.filter.all': 'Tous les statuts',
    'showcase.table.closeFor': 'Fermer les détails de {service}',
    'showcase.table.details': '{service} est au statut {status}, dernière modification le {date}.',
    'showcase.table.empty': 'Aucun service ne correspond à ces filtres.',
    'showcase.table.results': 'Résultats : {count}',
    'showcase.feedback.executed': 'Action exécutée.',
    'showcase.feedback.cancelled': 'Action annulée.',
    ...
    'showcase.block.copy': 'Le noir apporte du contraste et structure la lecture, sans effet décoratif gratuit.',
  ...
  en: {
    ...
    'page.showcase': 'Interface system — froment.software',
    ...
    'products.contact.showcase': 'Explore Froment UI',
    ...
    'showcase.kicker': 'Interface system',
    'showcase.title': 'Froment UI',
    'showcase.lead': 'Direct, readable and functional components. Depth appears only when it clarifies an action.',
    ...
    'showcase.form': 'Form',
    'showcase.form.projectLabel': 'Client project',
    'showcase.form.environmentLabel': 'Environment',
    'showcase.clientProject': 'Client project',
    'showcase.production': 'Production',
    'showcase.staging': 'Staging',
    'showcase.option': 'Option enabled',
    'showcase.table': 'Table',
    'showcase.table.caption': 'Demo service status',
    'showcase.table.openFor': 'Open details for {service}',
    'showcase.table.service': 'Service',
    'showcase.table.status': 'Status',
    'showcase.table.updated': 'Updated',
    'showcase.table.action': 'Action',
    'showcase.table.open': 'open',
    'showcase.table.close': 'close',
    'showcase.search.label': 'Search services',
    'showcase.search.placeholder': 'Service name',
    'showcase.filter.status': 'Filter by status',
    'showcase.filter.all': 'All statuses',
    'showcase.table.closeFor': 'Close details for {service}',
    'showcase.table.details': '{service} has status {status}, last updated on {date}.',
    'showcase.table.empty': 'No services match these filters.',
    'showcase.table.results': 'Results: {count}',
    'showcase.feedback.executed': 'Action run.',
    'showcase.feedback.cancelled': 'Action cancelled.',
    'showcase.status.ok': 'ok',
    ...
    'showcase.block.copy': 'Black adds contrast and reading structure without gratuitous decoration.',
