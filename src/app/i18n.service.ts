...
const translations = {
  fr: {
    ...
    'legal.updated': 'Dernière mise à jour : à définir',
    'legal.publisher.title': '1. Éditeur du site',
    'legal.publisher.content': 'Informations à compléter — raison sociale, statut juridique, SIREN, TVA intracommunautaire.',
    'legal.hosting.title': '2. Hébergement',
    'legal.hosting.content': 'Informations à compléter — nom et coordonnées de l\'hébergeur.',
    ...
    'privacy.updated': 'Dernière mise à jour : à définir',
    ...
    'cookies.updated': 'Dernière mise à jour : à définir',
  ...
  en: {
    ...
    'legal.updated': 'Last updated: TBD',
    'legal.publisher.title': '1. Publisher',
    'legal.publisher.content': 'Information to be completed — company name, legal status, SIREN, EU VAT number.',
    'legal.hosting.title': '2. Hosting',
    'legal.hosting.content': 'Information to be completed — hosting provider name and address.',
    ...
    'privacy.updated': 'Last updated: TBD',
    ...
    'cookies.updated': 'Last updated: TBD',
