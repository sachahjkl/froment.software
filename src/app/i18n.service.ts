...
const translations = {
  fr: {
    ...
    'services.practical.method.desc': 'Forfait après cadrage, avec des validations convenues avant le développement.',
    ...
    'services.practical.note': 'Une réécriture complète n’est jamais le point de départ.',
  ...
  en: {
    ...
    'services.practical.method.desc': 'Fixed price after scoping, with approvals agreed before development.',
    ...
    'services.practical.note': 'A complete rewrite is never the starting point.',
