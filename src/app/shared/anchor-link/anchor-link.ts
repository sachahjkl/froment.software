...
@Component({
  ...
  `,
  styles: `
    :host { display: inline-flex; margin-left: var(--space-2); }
    .anchor-link { padding-inline: var(--space-1); color: var(--color-muted); font-weight: 400; text-decoration: none; opacity: 0.45; transition: opacity var(--duration-base) var(--ease-out); }
    .anchor-link:focus-visible { opacity: 1; }
    :host-context(.anchored-title:hover) .anchor-link { opacity: 0.45; }
