...
export const SupplierInvoice = Schema.Struct({
  ...
  vatTotalCents: MoneyCents,
  totalCents: MoneyCents,
  functionalCurrency: Schema.NullOr(FunctionalCurrency),
  exchangeRateDate: Schema.NullOr(CalendarDate),
  foreignUnitsPerFunctionalUnitNanos: Schema.NullOr(MoneyCents),
  functionalNetTotalCents: Schema.NullOr(MoneyCents),
  functionalVatTotalCents: Schema.NullOr(MoneyCents),
  functionalTotalCents: Schema.NullOr(MoneyCents),
