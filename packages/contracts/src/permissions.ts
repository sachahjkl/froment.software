...
export const Permissions = {
  affairRead: { code: 'affair.read', audiences: ['api-token'] },
  affairCreate: { code: 'affair.create', audiences: ['api-token'] },
  affairUpdate: { code: 'affair.update', audiences: ['api-token'] },
  integrationConfigure: { code: 'integration.configure', audiences: [] },
  ledgerRead: { code: 'ledger.read', audiences: [] },
  ledgerPost: { code: 'ledger.post', audiences: [] },
  invoiceCredit: { code: 'invoice.credit', audiences: [] },
  invoiceRefund: { code: 'invoice.refund', audiences: [] },
  ...
  catalogRead: { code: 'catalog.read', audiences: [] },
  ...
  supplierRead: { code: 'supplier.read', audiences: ['api-token'] },
  supplierCreate: { code: 'supplier.create', audiences: ['api-token'] },
  supplierUpdate: { code: 'supplier.update', audiences: ['api-token'] },
  supplierArchive: { code: 'supplier.archive', audiences: ['api-token'] },
  supplierInvoiceRead: { code: 'supplier-invoice.read', audiences: ['api-token'] },
  ...
  supplierInvoicePay: { code: 'supplier-invoice.pay', audiences: [] },
