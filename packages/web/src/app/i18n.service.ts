...
const translations = {
  fr: {
    ...
    'backOffice.intro': 'Entrez votre identifiant secret pour accéder aux documents internes.',
  ...
  en: {
    ...
    'backOffice.title': 'Back office',
    'backOffice.intro': 'Enter your secret identifier to access internal documents.',
