...
const translations = {
  fr: {
    ...
    'backOffice.intro.client': 'Entrez votre identifiant secret pour accéder à vos documents.',
    'backOffice.intro.administrator':
      'Entrez votre identifiant secret pour administrer le back office.',
    'backOffice.accessIdentifier': 'Identifiant secret',
    ...
    'bootstrap.kicker': 'Configuration initiale',
    ...
    'bootstrap.success': 'Le compte administrateur est créé. Conservez son identifiant.',
    'bootstrap.accessIdentifier': 'Identifiant secret de connexion',
    'bootstrap.administratorId': 'ULID du compte',
    'bootstrap.copy': 'Copier l’identifiant',
    'bootstrap.copied': 'Identifiant copié',
  ...
  en: {
    ...
    'backOffice.kicker': 'Private access',
    'backOffice.title': 'Back office',
    'backOffice.mode': 'Access type',
    'backOffice.mode.client': 'Client',
    'backOffice.mode.administrator': 'Administrator',
    'backOffice.intro.client': 'Enter your secret identifier to access your documents.',
    'backOffice.intro.administrator': 'Enter your secret identifier to administer the back office.',
    'backOffice.accessIdentifier': 'Secret identifier',
    ...
    'bootstrap.kicker': 'Initial setup',
    ...
    'bootstrap.success': 'The administrator account is ready. Keep its identifier.',
    'bootstrap.accessIdentifier': 'Secret sign-in identifier',
    'bootstrap.administratorId': 'Account ULID',
    'bootstrap.copy': 'Copy identifier',
    'bootstrap.copied': 'Identifier copied',
