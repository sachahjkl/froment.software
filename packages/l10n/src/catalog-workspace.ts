export const catalogWorkspaceText = {
  fr: {
    ...
    'catalogWorkspace.count.one': '{count} prestation',
    'catalogWorkspace.count.other': '{count} prestations',
  ...
  en: {
    ...
    'catalogWorkspace.count.one': '{count} service',
    'catalogWorkspace.count.other': '{count} services',
