export const translations = {
  fr: {
    ...
    'privacy.storage.content':
      'Le navigateur conserve la langue (« froment.software.language ») et le thème (« froment.software.theme ») dans son stockage local. Ces préférences ne sont pas envoyées au serveur par la vitrine.',
    ...
    'cookies.control.content':
      'Utilisez les contrôles de langue et de thème pour modifier ces réglages. Vous pouvez aussi supprimer les données du site dans les réglages du navigateur.',
  ...
  en: {
    ...
    'privacy.storage.content':
      'The browser keeps the language (“froment.software.language”) and theme (“froment.software.theme”) in local storage. The public site does not send these preferences to the server.',
    ...
    'cookies.control.content':
      'Use the language and theme controls to change these settings. You can also clear site data in your browser.',
