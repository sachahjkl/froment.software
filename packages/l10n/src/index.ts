...
export const translations = {
  fr: {
    ...
    'backOffice.navigation.search': 'Recherche',
    'page.back_office_search': 'Recherche | Back office',
    ...
    'backOffice.affairs.eyebrow': 'Parcours commercial',
    ...
    'backOffice.affair.timeline.quoteSent': 'Devis envoyé',
    ...
    'backOffice.billing.eyebrow': 'Suivi financier',
    ...
    'backOffice.configuration.tabs': 'Sections de configuration',
    ...
    'backOffice.configuration.integrations': 'Intégrations',
    'backOffice.integrationTokens.title': 'Jetons d’intégration',
    'backOffice.integrationTokens.intro':
      'Créez des jetons limités aux opérations nécessaires pour connecter un logiciel externe.',
    'backOffice.integrationTokens.documentation': 'Ouvrir la documentation de l’API',
    'backOffice.integrationTokens.create': 'Créer un jeton',
    ...
    'backOffice.integrationTokens.createdAt': 'Créé le',
    'backOffice.integrationTokens.expiresAt': 'Expire le',
    'backOffice.integrationTokens.lastUsedAt': 'Dernière utilisation',
    'backOffice.integrationTokens.status': 'État',
    'backOffice.integrationTokens.actions': 'Actions',
    'backOffice.integrationTokens.never': 'Jamais',
    'backOffice.integrationTokens.status.active': 'Actif',
    'backOffice.integrationTokens.status.expired': 'Expiré',
    'backOffice.integrationTokens.status.revoked': 'Révoqué',
    'backOffice.integrationTokens.revoke': 'Révoquer',
    'backOffice.integrationTokens.revokeConfirmation':
      'Révoquer ce jeton ? Cette action est définitive.',
    'backOffice.integrationTokens.expirationInvalid': 'Choisissez une date future.',
    'backOffice.integrationTokens.secretTitle': 'Enregistrez ce secret maintenant',
    'backOffice.integrationTokens.secretWarning':
    ...
    'integration_token.invalid_expiration': 'La date d’expiration est invalide.',
    'integration_token.invalid_cursor': 'Le curseur de pagination est invalide.',
    ...
    'backOffice.clientDetail.accessIntro':
      'Générez un nouvel identifiant pour accéder aux documents de ce client.',
  ...
  en: {
    ...
    'backOffice.navigation.search': 'Search',
    'page.back_office_search': 'Search | Back office',
    ...
    'backOffice.affairs.eyebrow': 'Sales workflow',
    ...
    'backOffice.affair.timeline.quoteSent': 'Quote sent',
    ...
    'backOffice.billing.eyebrow': 'Financial tracking',
    ...
    'backOffice.configuration.tabs': 'Settings sections',
    ...
    'backOffice.configuration.integrations': 'Integrations',
    'backOffice.integrationTokens.title': 'Integration tokens',
    'backOffice.integrationTokens.intro':
      'Create tokens limited to the operations required by external software.',
    'backOffice.integrationTokens.documentation': 'Open the API documentation',
    'backOffice.integrationTokens.create': 'Create token',
    ...
    'backOffice.integrationTokens.permissions': 'Permissions',
    'backOffice.integrationTokens.createdAt': 'Created',
    'backOffice.integrationTokens.expiresAt': 'Expires',
    'backOffice.integrationTokens.lastUsedAt': 'Last used',
    'backOffice.integrationTokens.status': 'Status',
    'backOffice.integrationTokens.actions': 'Actions',
    'backOffice.integrationTokens.never': 'Never',
    'backOffice.integrationTokens.status.active': 'Active',
    'backOffice.integrationTokens.status.expired': 'Expired',
    'backOffice.integrationTokens.status.revoked': 'Revoked',
    'backOffice.integrationTokens.revoke': 'Revoke',
    'backOffice.integrationTokens.revokeConfirmation':
      'Revoke this token? This action is permanent.',
    'backOffice.integrationTokens.expirationInvalid': 'Select a future date.',
    'backOffice.integrationTokens.secretTitle': 'Save this secret now',
    'backOffice.integrationTokens.secretWarning':
    ...
    'integration_token.invalid_expiration': 'The expiration date is invalid.',
    'integration_token.invalid_cursor': 'The pagination cursor is invalid.',
    'backOffice.clients.title': 'Clients',
    ...
    'backOffice.clientDetail.accessIntro':
      'Generate a new identifier to access this client’s documents.',
