export const affairText = {
  fr: {
    ...
    'affair.linkQuote': 'Lier un devis existant',
    'affair.selectQuote': 'Sélectionnez un devis',
    'affair.link': 'Lier le devis',
  ...
  en: {
    ...
    'affair.linkQuote': 'Link an existing quote',
    'affair.selectQuote': 'Select a quote',
    'affair.link': 'Link quote',
