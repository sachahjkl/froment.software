...
it('parses configurable CSV columns and European number formats', () => {
  expect(
    ...
    { reference: 'FR-1', bookedOn: '2026-09-12', amountCents: 12_501, description: 'Règlement' },
  ]);
});
...
it('parses CAMT.053 and OFX statements', () => {
  ...
  expect(
    ...
    { reference: 'CAMT-1', bookedOn: '2026-09-12', amountCents: 1_250, description: 'Transfer' },
  ]);
