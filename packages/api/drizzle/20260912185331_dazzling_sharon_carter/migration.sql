ALTER TABLE `supplier_invoices` ADD `document_kind` text DEFAULT 'invoice' NOT NULL;--> statement-breakpoint
ALTER TABLE `supplier_invoices` ADD `source_invoice_id` text;--> statement-breakpoint
